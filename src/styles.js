...
export const tokens = {
  ...
  dark: {
    ...
    danger:           '#ef4444',
    'danger-bg':      '#4c1d24', 'danger-text':  '#fca5a5', 'danger-border': '#ef4444',
    success:          '#22c55e',
    'success-bg':     '#14532d', 'success-text': '#86efac', 'success-border': '#22c55e',
    warning:          '#facc15',
    'warning-bg':     '#431407', 'warning-text': '#fde68a', 'warning-border': '#facc15',
    info:             '#60a5fa',
    'info-bg':        '#1e3a5f', 'info-text':    '#93c5fd', 'info-border':    '#60a5fa',
