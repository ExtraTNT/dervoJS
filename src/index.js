...
// Game engine
export { createGame, Scene, Choice, ChoiceList, withTick, NpcChoices, NpcLine } from './game.js';
export { Stats, Resources, Inventory, Shop }                                    from './components/GameWidgets.js';
...
// elements generated with vim macro, maybe fucked
export {a, abbr, address, article, aside, audio, b, bdi, bdo, blockquote, br, button, canvas, caption, cite, code, col, colgroup, data, datalist, dd, del, details, dfn, dialog, div, dl, dt, em, fieldset, figcaption, figure, footer, form, h1, h2, h3, h4, h5, h6, header, hr, i, iframe, img, input, ins, kbd, label, legend, li, main, mark, menu, meter, nav, noscript, object, ol, optgroup, option, output, p, picture, pre, progress, q, s, samp, section, select, small, source, span, strong, sub, summary, sup, table, tbody, td, template, textarea, tfoot, th, thead, time, tr, track, u, ul, video, wbr, sa, sabbr, saddress, sarticle, saside, saudio, sb, sblockquote, sbutton, scanvas, scaption, scite, scode, sdata, sdd, sdel, sdetails, sdialog, sdiv, sdl, sdt, sem, sfieldset, sfigcaption, sfigure, sfooter, sform, sh1, sh2, sh3, sh4, sh5, sh6, sheader, si, siframe, simg, sinput, sins, skbd, slabel, slegend, sli, smain, smark, smenu, smeter, snav, sobject, sol, soptgroup, soption, soutput, sp, spicture, spre, sprogress, sq, ss, ssamp, ssection, sselect, ssmall, ssource, sspan, sstrong, ssub, ssummary, ssup, stable, stbody, std, stextarea, stfoot, sth, sthead, stime, str, su, sul, svideo, flexRow, flexCol, inlineFlex, relDiv, absDiv, fillDiv, empty, vst } from './elements.js'; 